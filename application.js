    ...
    function initialize_data(){
      ...
      load_thought_in_dialog("Julie Zinger","I cant find out how 2 get 2 check my email. My password is 'password', but theirs no place to put it. Can you help me.","1 June 2011 13:22", [["John Spitzer","I think you're in the wrong forum.","1 June 2011 18:22"]]); 
      load_thought_in_dialog("Darren Peakock","I hate blue. Can you add more pink?","1 June 2011 22:22", []);       
      load_thought_in_dialog("Brenda Jones","Make the logo bigger","1 June 2011 23:22", []);      
      return true;
    }
       ...
       $("#submit").click(function() {
         ...
         $.ajax({  
           ...
           success: function(data) {
             //append new thought or reply to existing display
             data = jQuery.parseJSON(data);
             $("#name").val("Your name");    
             $("#thought_text").val("Enter your thought here...");
             if(data[0] == "thought"){
               load_thought_in_dialog(data[1],data[2],data[3],[]);
             } else {
               $("#reply_id").val("");
               $("#reply_message").hide();
               load_reply_in_dialog(data[1],data[2],data[3],data[4]);
             }
             jQuery("span.timeago").timeago();
           }
         });
